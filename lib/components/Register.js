...
exports.default = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    _createClass(_class, [{
        ...
        value: function doReg(e) {
            ...
            }).length != 5) return _message2.default.error('不能留空!');
            if (this.state.pass != this.state.paxx) return _message2.default.error('两次输入密码不同!');
            this.setState({ loading: true });
            fetch(_Config2.default.getServer('/user'), _Config2.default.getFetch('POST', {
