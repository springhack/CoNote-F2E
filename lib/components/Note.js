...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(converter, 'converter', 'src/common/components/Note.js');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/common/components/Note.js');
}();
